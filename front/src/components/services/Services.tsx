                    ...
                    >
                        {services.map((service, index) => (
                            <NavLink
                                ...
                                to={
                                    index === 0 ? `${"tel:" + service.phone}` : index === 1 ? service.link : index === 3 ? `/${data.site.url}/${data.site.name}/news` : "#"
                                }
                                onClick={() => {
                            ...
                            >
                                {service.image.length > 0 ? (
                                    <div
                                        className="w-[24px] h-[24px] max-w-[24px] max-h-[24px] md:w-[50px] md:h-[50px]  md:max-w-[50px] md:max-h-[50px]">
                                        <img
                                            src={service.image}
                                            alt={service.title}
