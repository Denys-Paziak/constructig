                    ...
                    {data.categories.length > 0 ? (
                        data.categories.map((category) => (
                            ...
                            >
                                ...
                                <div
                                    className="w-[70%] md:w-[50%] py-3 md:py-0 rounded-t-lg md:rounded-none md:bg-none flex items-center justify-center category-top">
                                    <h3
                    ...
                    <div className="w-full flex flex-col gap-4">
                        {filteredItems.length > 0 ? (
                            filteredItems.map((item) => (
                                ...
                                >
                                    <div
                                        className="w-[70%] md:w-[50%] flex flex-col gap-[6px] md:gap-[20px] p-[6px] md:p-[40px]">
