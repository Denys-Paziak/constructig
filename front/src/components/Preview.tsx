...
const Preview: React.FC<PreviewProps> = ({
  ...
  return (
    <div className={`${type === "constructor" ? "w-[75%]  h-[100vh] overflow-scroll " : "w-[100%]"} flex items-center flex-col bg-gray-200 `}>
      {type === "constructor" ?
      ...
      >
        <div className={`${type === "constructor" ? "rounded-xl overflow-hidden" : ""}`}>
          {data.header?.visible && (
            <Header
          ...
          {data.slider?.visible && (
            <Slider images={data.slider.images || []} backgroundColor={headerColorBg} textColor={headerTextColor} />
          )}
