...
=======
        ...
        if (localBasket) {
            ...
            data.splice(index, 1);
>>>>>>> 60ebe8198b80f44de8e12f0cccce85982757d728

            const totalPrice = data.reduce((acc: number, el: any) => acc + el.price, 0);
...
>>>>>>> 60ebe8198b80f44de8e12f0cccce85982757d728
            >
                <div
                    className="absolute -top-2 -left-2 w-6 h-6 flex justify-center items-center rounded-full bg-amber-50 text-black border-[1px] border-black shadow-sm text-xs font-bold animate-pulse">
                    {basket.length}
                </div>
...
=======
            ...
            {basketMenu && (
                <div className="fixed z-[1000] w-full h-full bg-white overflow-y-scroll p-6 shadow-lg animate-fadeIn">
                    <div
                        className="absolute top-5 right-5 text-3xl cursor-pointer transform transition-transform hover:scale-110 hover:text-red-600"
                        onClick={() => {
                            setBasketMenu(false);
                        }}
                    >
                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        {basket.length === 0 ? (
                            <div className="text-center text-xl text-gray-500">Your basket is empty</div>
                        ) : (
                ...
                >
                  {el.price} €
                        ...
                        <div className="border-t border-gray-300 mt-6 pt-6 flex flex-col items-end">
                            ...
                            <button
                                className="mt-4 px-6 py-3 bg-green-600 text-white font-bold rounded-lg shadow hover:bg-green-700 transform transition-transform duration-300 hover:scale-105"
                                style={{
                                    background: `rgba(${data.global.main_bg_color.r}, ${data.global.main_bg_color.g}, ${data.global.main_bg_color.b}, ${data.global.main_bg_color.a})`,
                                }}
                            >
            ...
            >
                ...
                >
                    ...
                    {showWifi && <div
                        className={"fixed top-0 left-0 w-full h-[100vh] bg-red-400 z-[100] flex justify-center items-center flex-col"}>
