...
const NewsDisplay: React.FC = () => {
    ...
    return (
        <div
            ...
            style={{
                background: `rgba(${data.global.main_bg_color.r}, ${data.global.main_bg_color.g}, ${data.global.main_bg_color.b}, ${+data.global.main_bg_color.a / 6})`,
            }}
        >
            <div
                className="rounded-lg flex flex-col gap-4 p-3"
                style={{
                    background: `rgba(${data.global.site_text_color.r}, ${data.global.site_text_color.g}, ${data.global.site_text_color.b}, ${data.global.site_text_color.a / 4})`,
                }}
            >
                {data.global.news.length > 0 ? (
                    data.global.news.map((oneNew: INew) => (
                        <div
                            ...
                            style={{
                                background: `rgba(${data.global.main_bg_color.r}, ${data.global.main_bg_color.g}, ${data.global.main_bg_color.b}, ${+data.global.main_bg_color.a / 1.1})`,
                            }}
                        >
                    ...
                    <div className="flex flex-col items-center justify-center py-8">
                        ...
                        >
                            Наразі новин немає, але вони з'являться незабаром!
                        </p>
                    </div>
                )}
            </div>
