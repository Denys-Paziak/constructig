...
export const getUserSites = async (token: string): Promise<GetUserSitesResponse> => {
...
export const getSite = async (id: number, token: string): Promise<GetSiteResponse> => {
...
export const addSite = async (name: string, url: string, token: string): Promise<any> => {
