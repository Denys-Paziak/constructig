...
export const updateSocial = async (req, res) => {
    ...
    const { visible, instagram, facebook, youtube, messenger, whatsApp, viber, x, tikTok } = data;

    let params = [visible, instagram, facebook, youtube, messenger, whatsApp, viber, x, tikTok, siteId];
