...
import { createSite, getSite, updateSite, deleteSite, getUserSites, updateHeader, updateSlider } from '../controllers/site.js';
...
router.put('/site/slider/:siteId', upload.fields([{ name: 'slides', maxCount: 3 }]), authMiddleware, updateSlider);
